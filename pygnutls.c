...
static int _libgnutls_pin_callback(void *userdata,
                                   int attempt,
...
static PyObject *_libgnutls_pkcs11_set_pin_function(PyObject *dummy,
                                                    PyObject *args)
{
...
{
    gnutls_pkcs11_set_pin_function(_libgnutls_pin_callback, NULL);
...
static PyMethodDef _libgnutlsModule_methods[] = {
    ...
    {"pkcs11_set_pin_function", _libgnutls_pkcs11_set_pin_function, METH_VARARGS},
    {NULL, NULL, 0}
};
